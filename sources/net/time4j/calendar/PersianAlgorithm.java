...
public enum PersianAlgorithm {
    ...
    KHAYYAM { // from class: net.time4j.calendar.PersianAlgorithm.2
        ...
        public long transform(PersianCalendar persianCalendar, ZonalOffset zonalOffset) {
            ...
            int i2 = 0;
            while (i2 < i) {
                j += (i2 == 1 || i2 == 5 || i2 == 9 || i2 == 13 || i2 == 17 || i2 == 22 || i2 == 26 || i2 == 30) ? 366 : 365;
                i2++;
            }
            int value = persianCalendar.getMonth().getValue();
            return ((j + (value <= 7 ? (value - 1) * 31 : ((value - 1) * 30) + 6)) + persianCalendar.getDayOfMonth()) - 1;
        }
    },
    BIRASHK { // from class: net.time4j.calendar.PersianAlgorithm.3
        ...
        public long transform(PersianCalendar persianCalendar, ZonalOffset zonalOffset) {
            ...
            return ((MathUtils.floorDivide(year, 2820) * 1029983) - 492998) + ((floorModulo - 1) * 365) + MathUtils.floorDivide((floorModulo * 31) - 5, 128) + (persianCalendar.getMonth().getValue() <= 7 ? (value - 1) * 31 : ((value - 1) * 30) + 6) + persianCalendar.getDayOfMonth();
        }
    },
