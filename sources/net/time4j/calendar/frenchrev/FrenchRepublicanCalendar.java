...
public final class FrenchRepublicanCalendar extends Calendrical<Unit, FrenchRepublicanCalendar> {
    ...
    static {
        ...
        CALSYS = transformer;
        ENGINE = TimeAxis.Builder.setUp(Unit.class, FrenchRepublicanCalendar.class, new Merger(null), transformer).appendElement((ChronoElement) stdEnumDateElement, (ElementRule) new EraRule(null)).appendElement(yearOfEraElement, new IntegerRule(0), Unit.YEARS).appendElement((ChronoElement) sansculottidesAccess, (ElementRule) sansculottidesAccess).appendElement(stdEnumDateElement2, new MonthRule(null), Unit.MONTHS).appendElement(stdIntegerDateElement, new IntegerRule(1), Unit.DECADES).appendElement(stdIntegerDateElement2, new IntegerRule(2), Unit.DAYS).appendElement(stdIntegerDateElement3, new IntegerRule(3), Unit.DAYS).appendElement(stdWeekdayElement, new WeekdayRule(null), Unit.DAYS).appendElement((ChronoElement) dayOfDecadeAccess, (ElementRule) dayOfDecadeAccess).appendUnit(Unit.YEARS, new FUnitRule(Unit.YEARS), Unit.YEARS.getLength()).appendUnit(Unit.MONTHS, new FUnitRule(Unit.MONTHS), Unit.MONTHS.getLength()).appendUnit(Unit.DECADES, new FUnitRule(Unit.DECADES), Unit.DECADES.getLength()).appendUnit(Unit.WEEKS, new FUnitRule(Unit.WEEKS), Unit.WEEKS.getLength(), Collections.singleton(Unit.DAYS)).appendUnit(Unit.DAYS, new FUnitRule(Unit.DAYS), Unit.DAYS.getLength(), Collections.singleton(Unit.WEEKS)).build();
    }
    ...
    public Date getDate(FrenchRepublicanAlgorithm frenchRepublicanAlgorithm) {
        ...
        if (frenchRepublicanAlgorithm == frenchRepublicanAlgorithm2) {
            return new Date(this, frenchRepublicanAlgorithm2, null);
        }
        return new Date(frenchRepublicanAlgorithm.transform(frenchRepublicanAlgorithm2.transform(this)), frenchRepublicanAlgorithm, null);
    }
    ...
    public <V> boolean isValid(ChronoElement<V> chronoElement, V v) {
        if (chronoElement == MONTH_OF_YEAR) {
            return v != null;
        } else if (chronoElement == SANSCULOTTIDES) {
            return SANSCULOTTIDES_ACCESS.isValid(this, (Sansculottides) Sansculottides.class.cast(v));
        } else {
    ...
    private static class Merger implements ChronoMerger<FrenchRepublicanCalendar> {
        ...
        public FrenchRepublicanCalendar createFrom2(ChronoEntity<?> chronoEntity, AttributeQuery attributeQuery, boolean z, boolean z2) {
            ...
            if (i2 == Integer.MIN_VALUE) {
                ...
                chronoEntity.with((ChronoElement<ValidationElement>) validationElement, (ValidationElement) ("Republican year out of range: " + i2));
                return null;
            } else {
    ...
    private static class FUnitRule implements UnitRule<FrenchRepublicanCalendar> {
        ...
        public long between(FrenchRepublicanCalendar frenchRepublicanCalendar, FrenchRepublicanCalendar frenchRepublicanCalendar2) {
            ...
            if (i == 1) {
                ...
                int i3 = (ymValue > 0L ? 1 : (ymValue == 0L ? 0 : -1));
                return (i3 <= 0 || dayOfMonth2 >= dayOfMonth) ? (i3 >= 0 || dayOfMonth2 <= dayOfMonth) ? ymValue : ymValue + 1 : ymValue - 1;
            } else if (i != 3) {
                if (i != 4) {
                    if (i == 5) {
                ...
                int i4 = (decValue > 0L ? 1 : (decValue == 0L ? 0 : -1));
                return (i4 <= 0 || value2 >= value) ? (i4 >= 0 || value2 <= value) ? decValue : decValue + 1 : decValue - 1;
            }
        }
    ...
    /* renamed from: net.time4j.calendar.frenchrev.FrenchRepublicanCalendar$1 */
    /* loaded from: classes2.dex */
