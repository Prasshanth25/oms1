...
public abstract class EastAsianCS<D extends EastAsianCalendar<?, D>> implements CalendarSystem<D> {
    ...
    private static final long MAX_LIMIT = PlainDate.of((int) PathInterpolatorCompat.MAX_NUM_POINTS, 1, 27).getDaysSinceEpochUTC();
    ...
    public /* bridge */ /* synthetic */ long transform(Object obj) {
        return transform((EastAsianCS<D>) ((EastAsianCalendar) obj));
    }
