...
public final class JucheCalendar extends Calendrical<CalendarUnit, JucheCalendar> implements LocalizedPatternSupport {
    ...
    private static class FieldRule<V extends Comparable<V>> implements ElementRule<JucheCalendar, V> {
        ...
        public /* bridge */ /* synthetic */ boolean isValid(JucheCalendar jucheCalendar, Object obj) {
            return isValid(jucheCalendar, (JucheCalendar) obj);
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ JucheCalendar withValue(JucheCalendar jucheCalendar, Object obj, boolean z) {
            return withValue(jucheCalendar, (JucheCalendar) obj, z);
        }
        ...
        public JucheCalendar withValue(JucheCalendar jucheCalendar, V v, boolean z) {
            if (!isValid(jucheCalendar, (JucheCalendar) v)) {
