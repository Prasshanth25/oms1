...
public final class HinduVariant implements VariantSource, Serializable {
    ...
    /* renamed from: net.time4j.calendar.hindu.HinduVariant$1 */
    /* loaded from: classes2.dex */
    ...
    public static class ModernHinduCS extends HinduCS {
        ...
        private static HinduCalendar hLunarFromFixed(long j, HinduVariant hinduVariant) {
            ...
            int hZodiac;
            int hZodiac2;
            double transform2 = EpochDays.RATA_DIE.transform(j, EpochDays.UTC);
            double hSunrise = hSunrise(transform2, hinduVariant);
            ...
            return new HinduCalendar(hinduVariant, hCalendarYear(transform2, hinduVariant), ofLunisolar, valueOf, j);
        }
        ...
        private static long hFixedFromLunar(int i, HinduMonth hinduMonth, HinduDay hinduDay, HinduVariant hinduVariant) {
            ...
            long modulo = (14 + ((floor + value2) - hLunarDayFromMoment)) - ((int) modulo((hLunarDayFromMoment(j + 0.25d, hinduVariant) - value2) + 15, 30.0d));
            while (true) {
