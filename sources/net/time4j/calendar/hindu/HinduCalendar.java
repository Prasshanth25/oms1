...
public final class HinduCalendar extends CalendarVariant<HinduCalendar> implements LocalizedPatternSupport {
    ...
    /* JADX WARN: Removed duplicated region for block: B:56:0x0036 A[RETURN] */
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:59:0x003a A[RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    public static HinduVariant getVariant(ChronoDisplay chronoDisplay, AttributeQuery attributeQuery) {
        ...
        String obj = chronoDisplay == null ? "<attributes>" : chronoDisplay.toString();
        throw new IllegalArgumentException("Cannot infer Hindu calendar variant: " + obj);
    }
    ...
    private static class Merger implements ChronoMerger<HinduCalendar> {
        ...
        public HinduCalendar createFrom2(TimeSource<?> timeSource, AttributeQuery attributeQuery) {
            ...
            StartOfDay definedBy = StartOfDay.definedBy(SolarTime.ofLocation(location.getLatitude(), location.getLongitude(), location.getAltitude(), StdSolarCalculator.CC).sunrise());
            return (HinduCalendar) Moment.from(timeSource.currentTime()).toGeneralTimestamp(HinduCalendar.ENGINE, str, atLongitude, (StartOfDay) attributeQuery.get(Attributes.START_OF_DAY, definedBy)).toDate();
        }
