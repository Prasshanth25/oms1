...
public final class JulianCalendar extends Calendrical<Unit, JulianCalendar> implements LocalizedPatternSupport {
        ...
        public long between(JulianCalendar julianCalendar, JulianCalendar julianCalendar2) {
            ...
            if (i != 1) {
                if (i == 2) {
                    ...
                    return (i2 <= 0 || julianCalendar2.dom >= julianCalendar.dom) ? (i2 >= 0 || julianCalendar2.dom <= julianCalendar.dom) ? ymValue : ymValue + 1 : ymValue - 1;
                } else if (i != 3) {
                    if (i == 4) {
    ...
    /* renamed from: net.time4j.calendar.JulianCalendar$2 */
    /* loaded from: classes2.dex */
