...
public final class IndianCalendar extends Calendrical<Unit, IndianCalendar> implements LocalizedPatternSupport {
    ...
    private static class Transformer implements EraYearMonthDaySystem<IndianCalendar> {
        ...
        public int getLengthOfYear(CalendarEra calendarEra, int i) {
            ...
            } else if (i == IndianCalendar.MAX_YEAR) {
                return 285;
            } else {
                                        ...
                                        if (month == 6) {
                                            ...
                                            if (month == 5) {
                                                ...
                                                if (month == 4) {
                                                    ...
                                                    return IndianCalendar.of(year2, i3, i);
                                                } else {
                                                    i = (dayOfMonth - i2) + 1;
                                                }
                                                i3 = 1;
        ...
        public long between(IndianCalendar indianCalendar, IndianCalendar indianCalendar2) {
            ...
            if (i != 1) {
                if (i == 2) {
                    ...
                    return (i2 <= 0 || indianCalendar2.idom >= indianCalendar.idom) ? (i2 >= 0 || indianCalendar2.idom <= indianCalendar.idom) ? ymValue : ymValue + 1 : ymValue - 1;
                } else if (i != 3) {
                    if (i == 4) {
    ...
    /* renamed from: net.time4j.calendar.IndianCalendar$2 */
    /* loaded from: classes2.dex */
