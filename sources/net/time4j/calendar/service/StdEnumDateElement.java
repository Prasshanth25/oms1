...
public class StdEnumDateElement<V extends Enum<V>, T extends ChronoEntity<T>> extends StdDateElement<V, T> implements NumericalElement<V>, TextElement<V> {
    ...
    public /* bridge */ /* synthetic */ int numerical(Object obj) {
        return numerical((StdEnumDateElement<V, T>) ((Enum) obj));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public /* bridge */ /* synthetic */ int printToInt(Object obj, ChronoDisplay chronoDisplay, AttributeQuery attributeQuery) {
        return printToInt((StdEnumDateElement<V, T>) ((Enum) obj), chronoDisplay, attributeQuery);
    }
    ...
    protected TextAccessor accessor(AttributeQuery attributeQuery, OutputContext outputContext, boolean z) {
        ...
        CalendarText calendarText = CalendarText.getInstance(getCalendarType(attributeQuery), (Locale) attributeQuery.get(Attributes.LANGUAGE, Locale.ROOT));
        if (isMonthElement()) {
            if (z) {
