...
public enum Zodiac {
    ...
    public static class Event implements ChronoCondition<Moment> {
        ...
        public boolean test(Moment moment) {
            ...
            if (this.horoscope) {
                eclipticAngle = getHoroscopeLongitude(false);
                eclipticAngle2 = getHoroscopeLongitude(true);
            } else {
                Zodiac zodiac = this.zodiac;
                Zodiac next = zodiac.next();
                eclipticAngle = Zodiac.toEclipticAngle(moment2, zodiac.entry.getRightAscension(), zodiac.entry.getDeclination());
                eclipticAngle2 = Zodiac.toEclipticAngle(moment2, next.entry.getRightAscension(), next.entry.getDeclination());
            }
            if (eclipticAngle2 < eclipticAngle) {
                eclipticAngle2 += 360.0d;
                if (solarLongitude < 180.0d) {
            ...
            return solarLongitude >= eclipticAngle && solarLongitude < eclipticAngle2;
        }

        public static Event ofSign(char c, Zodiac zodiac) {
            return new Event(c, zodiac, true);
        }

        public static Event ofConstellation(char c, Zodiac zodiac) {
