...
public final class MinguoCalendar extends Calendrical<CalendarUnit, MinguoCalendar> implements LocalizedPatternSupport {
    ...
    private static class FieldRule<V extends Comparable<V>> implements ElementRule<MinguoCalendar, V> {
        ...
        public /* bridge */ /* synthetic */ boolean isValid(MinguoCalendar minguoCalendar, Object obj) {
            return isValid(minguoCalendar, (MinguoCalendar) obj);
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ MinguoCalendar withValue(MinguoCalendar minguoCalendar, Object obj, boolean z) {
            return withValue(minguoCalendar, (MinguoCalendar) obj, z);
        }
        ...
        public V getMinimum(MinguoCalendar minguoCalendar) {
            ...
            return this.element.getType().cast(i);
        }
        ...
        public MinguoCalendar withValue(MinguoCalendar minguoCalendar, V v, boolean z) {
            if (!isValid(minguoCalendar, (MinguoCalendar) v)) {
