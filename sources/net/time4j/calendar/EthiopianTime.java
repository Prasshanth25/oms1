...
public final class EthiopianTime extends TimePoint<Unit, EthiopianTime> implements Temporal<EthiopianTime>, LocalizedPatternSupport {
    ...
    private static void registerExtensions(TimeAxis.Builder<Unit, EthiopianTime> builder) {
        ...
        for (ChronoExtension chronoExtension : PlainTime.axis().getExtensions()) {
            ...
            if (elements.size() == 2) {
                for (ChronoElement<?> chronoElement : elements) {
    ...
    /* renamed from: net.time4j.calendar.EthiopianTime$1 */
    /* loaded from: classes2.dex */
    ...
    private static class GeneralHourRule<T extends ChronoEntity<T>> implements ElementRule<T, Integer> {
        ...
        public /* bridge */ /* synthetic */ ChronoElement getChildAtCeiling(Object obj) {
            return getChildAtCeiling((GeneralHourRule<T>) ((ChronoEntity) obj));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ ChronoElement getChildAtFloor(Object obj) {
            return getChildAtFloor((GeneralHourRule<T>) ((ChronoEntity) obj));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ Integer getMaximum(Object obj) {
            return getMaximum((GeneralHourRule<T>) ((ChronoEntity) obj));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ Integer getMinimum(Object obj) {
            return getMinimum((GeneralHourRule<T>) ((ChronoEntity) obj));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ Integer getValue(Object obj) {
            return getValue((GeneralHourRule<T>) ((ChronoEntity) obj));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ boolean isValid(Object obj, Integer num) {
            return isValid((GeneralHourRule<T>) ((ChronoEntity) obj), num);
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ Object withValue(Object obj, Integer num, boolean z) {
            return withValue((GeneralHourRule<T>) ((ChronoEntity) obj), num, z);
        }
    ...
    private static class IntegerElementRule implements ElementRule<EthiopianTime, Integer> {
        ...
        public EthiopianTime withValue(EthiopianTime ethiopianTime, Integer num, boolean z) {
            ...
            if (i == 0) {
                ...
                if (i != 2) {
                    if (i == 3) {
                        return new EthiopianTime(ethiopianTime.hour24, ethiopianTime.minute, intValue, null);
                    }
                    throw new UnsupportedOperationException("Unknown element index: " + this.index);
                }
                return new EthiopianTime(ethiopianTime.hour24, intValue, ethiopianTime.second, null);
            } else {
                return new EthiopianTime(intValue, ethiopianTime.minute, ethiopianTime.second, null);
            }
        }
    }
