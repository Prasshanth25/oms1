...
public final class CopticCalendar extends Calendrical<Unit, CopticCalendar> implements LocalizedPatternSupport {
    ...
    private static class Transformer implements EraYearMonthDaySystem<CopticCalendar> {
        ...
        public CopticCalendar transform(long j) {
            try {
                int safeCast = MathUtils.safeCast(MathUtils.floorDivide(MathUtils.safeAdd(MathUtils.safeMultiply(4L, MathUtils.safeSubtract(j, CopticCalendar.DIOCLETIAN)), 1463L), 1461));
                int safeCast2 = MathUtils.safeCast(MathUtils.floorDivide(j - MathUtils.safeCast(transform(new CopticCalendar(safeCast, 1, 1))), 30)) + 1;
                return CopticCalendar.of(safeCast, safeCast2, MathUtils.safeCast(MathUtils.safeSubtract(j, MathUtils.safeCast(transform(new CopticCalendar(safeCast, safeCast2, 1))))) + 1);
    ...
    private static class CopticUnitRule implements UnitRule<CopticCalendar> {
        ...
        public long between(CopticCalendar copticCalendar, CopticCalendar copticCalendar2) {
            ...
            if (i == 1) {
                ...
                int i2 = (ymValue > 0L ? 1 : (ymValue == 0L ? 0 : -1));
                return (i2 <= 0 || copticCalendar2.cdom >= copticCalendar.cdom) ? (i2 >= 0 || copticCalendar2.cdom <= copticCalendar.cdom) ? ymValue : ymValue + 1 : ymValue - 1;
            } else if (i != 3) {
                if (i == 4) {
    ...
    /* renamed from: net.time4j.calendar.CopticCalendar$2 */
    /* loaded from: classes2.dex */
