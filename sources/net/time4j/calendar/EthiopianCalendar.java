...
public final class EthiopianCalendar extends Calendrical<Unit, EthiopianCalendar> implements LocalizedPatternSupport {
    ...
    private static class Transformer implements EraYearMonthDaySystem<EthiopianCalendar> {
        ...
        public EthiopianCalendar transform(long j) {
            try {
                ...
                int safeCast2 = MathUtils.safeCast(MathUtils.floorDivide(j - MathUtils.safeCast(transform(new EthiopianCalendar(safeCast, 1, 1))), 30)) + 1;
                int safeCast3 = MathUtils.safeCast(MathUtils.safeSubtract(j, MathUtils.safeCast(transform(new EthiopianCalendar(safeCast, safeCast2, 1))))) + 1;
    ...
    private static class EthiopianUnitRule implements UnitRule<EthiopianCalendar> {
        ...
        public long between(EthiopianCalendar ethiopianCalendar, EthiopianCalendar ethiopianCalendar2) {
            ...
            if (i == 1) {
                ...
                return (i2 <= 0 || ethiopianCalendar2.edom >= ethiopianCalendar.edom) ? (i2 >= 0 || ethiopianCalendar2.edom <= ethiopianCalendar.edom) ? ymValue : ymValue + 1 : ymValue - 1;
            } else if (i != 3) {
                if (i == 4) {
    ...
    /* renamed from: net.time4j.calendar.EthiopianCalendar$2 */
    /* loaded from: classes2.dex */
