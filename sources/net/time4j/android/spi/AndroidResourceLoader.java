...
public class AndroidResourceLoader extends ResourceLoader {
    ...
    static {
        ...
        hashMap.put(TextProvider.class, new LazyTextdata(null));
        hashMap.put(ZoneModelProvider.class, new LazyZoneRules(null));
        hashMap.put(ZoneNameProvider.class, new LazyZoneNames(null));
        hashMap.put(LeapSecondProvider.class, new LazyLeapseconds(null));
        hashMap.put(ChronoExtension.class, new LazyExtensions(null));
        hashMap.put(NumberSymbolProvider.class, new LazyNumberSymbols(null));
        hashMap.put(PluralProvider.class, new LazyPluraldata(null));
        hashMap.put(UnitPatternProvider.class, Collections.singleton(new UnitPatternProviderSPI()));
        hashMap.put(WeekdataProvider.class, new LazyWeekdata(null));
    ...
    /* renamed from: net.time4j.android.spi.AndroidResourceLoader$1 */
    /* loaded from: classes2.dex */
