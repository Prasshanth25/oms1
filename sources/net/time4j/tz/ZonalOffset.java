...
public final class ZonalOffset implements Comparable<ZonalOffset>, TZID, Serializable {
    ...
    static {
        ...
        DECIMAL_POS_180 = new BigDecimal((int) RotationOptions.ROTATE_180);
        DECIMAL_240 = new BigDecimal(240);
        MRD = new BigDecimal((int) Http2Connection.DEGRADED_PONG_TIMEOUT_NS);
    ...
    /* JADX WARN: Removed duplicated region for block: B:207:0x00d2 A[RETURN] */
