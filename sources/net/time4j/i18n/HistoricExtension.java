        ...
        if (chronoEntity.contains(chronoHistory.era())) {
            ...
            if (historicEra == null && chronoEntity.contains(chronoHistory.yearOfEra())) {
                ...
                if (chronoEntity.contains(chronoHistory.month()) && chronoEntity.contains(chronoHistory.dayOfMonth())) {
                    ...
                    chronoEntity.with(chronoHistory.era(), (ChronoElement) null);
                    ...
                    chronoEntity.with(chronoHistory.dayOfMonth(), (ChronoElement) null);
                    return chronoEntity.with((ChronoElement<CalendarDateElement>) PlainDate.COMPONENT, (CalendarDateElement) convert);
                } else if (chronoEntity.contains(chronoHistory.dayOfYear())) {
                    ...
                    return chronoEntity.with((ChronoElement<CalendarDateElement>) PlainDate.COMPONENT, (CalendarDateElement) ((PlainDate) chronoHistory.convert(chronoHistory.getBeginOfYear(historicEra, i)).with(chronoHistory.dayOfYear(), i2)));
                } else {
                    return chronoEntity;
                }
            }
