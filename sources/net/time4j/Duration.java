...
public final class Duration<U extends IsoUnit> extends AbstractDuration<U> implements Serializable {
    ...
    public static <U extends IsoUnit> Duration<U> of(long j, U u) {
        ...
        if (u instanceof ClockUnit) {
            ...
            if (symbol == '3') {
                ...
                j = MathUtils.safeMultiply(j, (long) MIO);
            } else if (symbol == '6') {
                u = (U) cast(ClockUnit.NANOS);
        ...
        return new Duration<>(arrayList, i < 0);
    }
    ...
    public Duration<U> plus(long j, U u) {
        ...
        if (u != null) {
            ...
            if (index < 0) {
                ...
                int i2 = (safeAdd > 0L ? 1 : (safeAdd == 0L ? 0 : -1));
                if (i2 == 0) {
    ...
    public Duration<U> with(long j, U u) {
        ...
        return plus(MathUtils.safeSubtract(MathUtils.safeMultiply(j, i < 0 ? -1L : 1L), MathUtils.safeMultiply(getPartialAmount((IsoUnit) u), isNegative() ? -1L : 1L)), u);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:377:0x01fc  */
    /*
    ...
    */
        ...
        for (Map.Entry<U, Long> entry : map.entrySet()) {
            ...
            if (longValue != 0) {
                ...
                if (key == ClockUnit.MILLIS) {
                    j = MathUtils.safeAdd(j, MathUtils.safeMultiply(longValue, (long) MIO));
    ...
    private static <U extends IsoUnit> TimeSpan.Item<U> replaceFraction(long j, U u) {
        ...
        if (u.equals(ClockUnit.MILLIS)) {
            safeMultiply = MathUtils.safeMultiply(j, (long) MIO);
            ...
            if (unit instanceof CalendarUnit) {
                ...
                switch (AnonymousClass2.$SwitchMap$net$time4j$ClockUnit[clockUnit.ordinal()]) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        j7 = MathUtils.safeAdd(j7, MathUtils.safeMultiply(j9, (long) MIO));
                        break;
                    case 5:
    ...
    /* renamed from: net.time4j.Duration$2 */
    /* loaded from: classes2.dex */
    ...
    public static class Metric<U extends IsoUnit> extends AbstractMetric<U, Duration<U>> {
        ...
        protected TimeSpan.Item<U> resolve(TimeSpan.Item<U> item) {
            ...
            if (unit.equals(ClockUnit.MILLIS)) {
                return TimeSpan.Item.of(MathUtils.safeMultiply(item.getAmount(), (long) Duration.MIO), ClockUnit.NANOS);
            }
    ...
    private static class LengthComparator<U extends IsoUnit, T extends TimePoint<U, T>> implements Comparator<Duration<? extends U>> {
        ...
        public /* bridge */ /* synthetic */ int compare(Object obj, Object obj2) {
            return compare((Duration) ((Duration) obj), (Duration) ((Duration) obj2));
        }
