...
public enum CalendarUnit implements IsoDateUnit {
    ...
    /* renamed from: net.time4j.CalendarUnit$9 */
    /* loaded from: classes2.dex */
    ...
    public static class Rule<T extends ChronoEntity<T>> implements UnitRule<T> {
        ...
        public /* bridge */ /* synthetic */ Object addTo(Object obj, long j) {
            return addTo((Rule<T>) ((ChronoEntity) obj), j);
        }
        ...
        public long between(T t, T t2) {
            ...
            int i = (dayDelta > 0L ? 1 : (dayDelta == 0L ? 0 : -1));
            if (i != 0 && t.contains(PlainTime.WALL_TIME) && t2.contains(PlainTime.WALL_TIME)) {
                ...
                if (z) {
                    ...
                    return (i <= 0 || !plainTime.isAfter(plainTime2)) ? (i >= 0 || !plainTime.isBefore(plainTime2)) ? dayDelta : dayDelta + 1 : dayDelta - 1;
                }
                return dayDelta;
            }
            return dayDelta;
        ...
        private long monthDelta(PlainDate plainDate, PlainDate plainDate2) {
            ...
            if (i == 5 || i == 2 || i == 6) {
                ...
                int i2 = (epochMonths > 0L ? 1 : (epochMonths == 0L ? 0 : -1));
            ...
            int i3 = (epochMonths > 0L ? 1 : (epochMonths == 0L ? 0 : -1));
