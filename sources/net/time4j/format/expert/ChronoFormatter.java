...
public final class ChronoFormatter<T> implements ChronoPrinter<T>, ChronoParser<T>, TemporalFormatter<T> {
    ...
    private ChronoFormatter(ChronoFormatter<T> chronoFormatter, Map<ChronoElement<?>, Object> map) {
        ...
        for (ChronoElement<?> chronoElement : map.keySet()) {
            checkElement(chronoFormatter.chronology, calendarOverride, chronoElement);
        }
        this.chronology = chronoFormatter.chronology;
        this.overrideHandler = chronoFormatter.overrideHandler;
        this.deepestParser = chronoFormatter.deepestParser;
        ...
        for (ChronoElement<?> chronoElement2 : map.keySet()) {
            Object obj = map.get(chronoElement2);
            if (obj == null) {
                hashMap.remove(chronoElement2);
            } else {
                hashMap.put(chronoElement2, obj);
                z = z && ParsedValues.isIndexed(chronoElement2);
            }
        }
    ...
    public T parse(CharSequence charSequence, ParseLog parseLog, AttributeQuery attributeQuery) {
        ...
        if (attributeQuery != attributeSet) {
            MergedAttributes mergedAttributes2 = new MergedAttributes(attributeQuery, attributeSet);
            mergedAttributes = mergedAttributes2;
            leniency = (Leniency) mergedAttributes2.get(Attributes.LENIENCY, Leniency.SMART);
            z = false;
        } else {
            leniency = leniency2;
            mergedAttributes = attributeQuery;
            z = true;
        }
        ...
        if (overrideHandler != null) {
            ...
            GeneralTimestamp generalTimestamp = (GeneralTimestamp) parse(this, overrideHandler2, extensions, charSequence, parseLog, mergedAttributes, leniency, true, z);
            if (parseLog.isError()) {
                return null;
            }
            ...
            if (tzid != null) {
                ...
                if (rawValues0.contains(FlagElement.DAYLIGHT_SAVING)) {
                    moment = generalTimestamp.in(Timezone.of(tzid).with(((TransitionStrategy) mergedAttributes.get(Attributes.TRANSITION_STRATEGY, Timezone.DEFAULT_CONFLICT_STRATEGY)).using(((Boolean) rawValues0.get(FlagElement.DAYLIGHT_SAVING)).booleanValue() ? OverlapResolver.EARLIER_OFFSET : OverlapResolver.LATER_OFFSET)), startOfDay);
                } else if (mergedAttributes.contains(Attributes.TRANSITION_STRATEGY)) {
                    moment = generalTimestamp.in(Timezone.of(tzid).with((TransitionStrategy) mergedAttributes.get(Attributes.TRANSITION_STRATEGY)), startOfDay);
                } else {
        ...
        return (T) parse(this, this.chronology, 0, charSequence, parseLog, mergedAttributes, leniency, z);
    }
    ...
    public static ChronoFormatter<Moment> ofMomentPattern(String str, PatternType patternType, Locale locale, TZID tzid) {
        ...
        addPattern(builder, str, patternType);
        try {
            return (ChronoFormatter<T>) builder.build().withTimezone(tzid);
        } catch (IllegalStateException e) {
            throw new IllegalArgumentException(e);
        }
    }
    ...
    private static ChronoFormatter<Moment> rfc1123() {
        ...
        up.addProcessor(new CustomizedProcessor(TimezoneElement.TIMEZONE_OFFSET, new ChronoPrinter<TZID>() { // from class: net.time4j.format.expert.ChronoFormatter.1
            ...
            public /* bridge */ /* synthetic */ Object print(TZID tzid, Appendable appendable, AttributeQuery attributeQuery, ChronoFunction chronoFunction) throws IOException {
                return print2(tzid, appendable, attributeQuery, (ChronoFunction<ChronoDisplay, Object>) chronoFunction);
            }
        ...
        return (ChronoFormatter<T>) up.build().withTimezone((TZID) ZonalOffset.UTC);
    }
    ...
    private ChronoDisplay display(T t, AttributeQuery attributeQuery) {
        ...
        try {
            ...
            if (CalendarVariant.class.isAssignableFrom(chronoType)) {
                ...
                generalTimestamp = moment.toGeneralTimestamp((CalendarFamily) cast(this.overrideHandler.getCalendarOverride()), str, tzid, startOfDay);
    ...
    private static <C> C parse(ChronoFormatter<?> chronoFormatter, Chronology<C> chronology, int i, CharSequence charSequence, ParseLog parseLog, AttributeQuery attributeQuery, Leniency leniency, boolean z) {
        ...
        if (parse == null) {
            ...
            parseLog.setError(length, getReason(rawValues) + getDescription(rawValues));
            return null;
        }
        ChronoEntity<?> rawValues0 = parseLog.getRawValues0();
        try {
            if (preparser instanceof TimeAxis) {
                ...
                try {
                    ...
                    parseLog.setError(length2, e.getMessage() + getDescription(rawValues0));
                    return null;
                }
            }
            if (createFrom != null) {
            ...
            if (!parseLog.isError()) {
                ...
                parseLog.setError(length3, getReason(rawValues0) + getDescription(rawValues0));
            }
            return null;
    ...
    /* JADX WARN: Removed duplicated region for block: B:283:0x00d0 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
    ...
    */
    ...
    private static <T> void addPattern(Builder<T> builder, String str, PatternType patternType) {
        ...
        if (i4 == 1 || i4 == 2 || i4 == 3 || i4 == 4) {
            ...
            } else if (sb2.contains("Y") && ((sb2.contains("M") || sb2.contains("L")) && !sb2.contains("w"))) {
                throw new IllegalArgumentException("Y as week-based-year requires a week-date-format: " + str);
            } else if (sb2.contains("D") && ((sb2.contains("M") || sb2.contains("L")) && !sb2.contains("d"))) {
    ...
    /* renamed from: net.time4j.format.expert.ChronoFormatter$3 */
    /* loaded from: classes2.dex */
            ...
            if (parseLog.isError()) {
                ...
                if (i3 > i6 || formatStep.isNewOrBlockStarted()) {
                    ...
                    while (true) {
                        if (i10 <= i8) {
                            break;
                        } else if (this.steps.get(i10).getSection() == section) {
                            i8 = i10;
                            break;
                        } else {
                            i10--;
    ...
    public static Chronology<?> checkElement(Chronology<?> chronology, Chronology<?> chronology2, ChronoElement<?> chronoElement) {
        ...
        if (chronology2 == null) {
            ...
            return chronology;
        } else if (chronoElement.isDateElement() && chronology2.isSupported(chronoElement)) {
            return chronology2;
        } else {
    ...
    private static boolean needsExtension(Chronology<?> chronology, Chronology<?> chronology2, ChronoElement<?> chronoElement) {
        for (ChronoExtension chronoExtension : chronology.getExtensions()) {
            if (chronoExtension.canResolve(chronoElement)) {
                return true;
            }
        }
        if (chronology2 != null) {
            if (chronoElement.isDateElement()) {
                ...
                for (ChronoExtension chronoExtension2 : chronology2.getExtensions()) {
                    if (chronoExtension2.canResolve(chronoElement)) {
                        return true;
                    }
                }
                return false;
            } else if (chronoElement.isTimeElement() && PlainTime.axis().isSupported(chronoElement)) {
                for (ChronoExtension chronoExtension3 : PlainTime.axis().getExtensions()) {
                    if (chronoExtension3.canResolve(chronoElement)) {
                        return true;
                    }
                }
                return false;
        ...
        while (true) {
            ...
            for (ChronoExtension chronoExtension4 : chronology.getExtensions()) {
                if (chronoExtension4.canResolve(chronoElement)) {
                    return true;
                }
            }
        }
    ...
    public static final class Builder<T> {
        ...
        public Chronology<?> getChronology() {
            ...
            return chronology == null ? (Chronology<T>) this.chronology : chronology;
        }
        ...
        private TextElement<?> findDayPeriodElement(boolean z, DayPeriod dayPeriod) {
            ...
            AttributeSet attributeSet = build;
            if (dayPeriod != null) {
                if (this.stack.isEmpty()) {
                ...
                attributeSet = last.withInternal(CUSTOM_DAY_PERIOD, dayPeriod);
            }
            for (ChronoExtension chronoExtension : PlainTime.axis().getExtensions()) {
                for (ChronoElement<?> chronoElement : chronoExtension.getElements(this.locale, attributeSet)) {
        ...
        private FormatStep checkAfterDecimalDigits(ChronoElement<?> chronoElement) {
            List<FormatStep> list;
            FormatStep formatStep;
            if (this.steps.isEmpty()) {
                formatStep = null;
            } else {
                formatStep = this.steps.get(list.size() - 1);
            }
            if (formatStep == null) {
                return null;
            }
    ...
    private static class TraditionalFormat<T> extends Format {
        ...
        public StringBuffer format(Object obj, StringBuffer stringBuffer, FieldPosition fieldPosition) {
            ...
            try {
                ...
                if (((String) attributeSet.get(Attributes.CALENDAR_TYPE, CalendarText.ISO_CALENDAR_TYPE)).equals(CalendarText.ISO_CALENDAR_TYPE)) {
    ...
    public static class OverrideHandler<C> implements ChronoMerger<GeneralTimestamp<C>> {
        ...
        public /* bridge */ /* synthetic */ ChronoDisplay preformat(Object obj, AttributeQuery attributeQuery) {
            return preformat((GeneralTimestamp) ((GeneralTimestamp) obj), attributeQuery);
        }
        ...
        public Chronology<?> getCalendarOverride() {
            return (Chronology<C>) this.override;
        }
