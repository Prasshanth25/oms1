...
public class NumberProcessor<V> implements FormatProcessor<V> {
    ...
    private NumberProcessor(ChronoElement<V> chronoElement, boolean z, int i, int i2, SignPolicy signPolicy, boolean z2, int i3, char c, NumberSystem numberSystem, Leniency leniency, int i4, boolean z3) {
        ...
        } else if (z && signPolicy != SignPolicy.SHOW_NEVER) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:460:0x026d  */
    /* JADX WARN: Removed duplicated region for block: B:465:0x027f  */
    /* JADX WARN: Removed duplicated region for block: B:483:0x02cb  */
    /* JADX WARN: Removed duplicated region for block: B:486:0x02da A[ADDED_TO_REGION] */
    @Override // net.time4j.format.expert.FormatProcessor
    /*
    ...
    */
    ...
    /* renamed from: net.time4j.format.expert.NumberProcessor$1 */
    /* loaded from: classes2.dex */
    ...
    /* JADX WARN: Removed duplicated region for block: B:662:0x0353  */
    /* JADX WARN: Removed duplicated region for block: B:663:0x035c  */
    @Override // net.time4j.format.expert.FormatProcessor
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
