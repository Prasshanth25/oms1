...
public final class AttributeSet implements AttributeQuery {
    ...
    public static AttributeSet createDefaults(Chronology<?> chronology, Attributes attributes, Locale locale) {
    ...
    public AttributeSet withAttributes(Attributes attributes) {
    ...
    public AttributeSet withLocale(Locale locale) {
        String str;
        String str2;
