...
public final class CalendarText {
    ...
    static {
        ...
        JDK_PROVIDER = new JDKTextProvider(null);
        ROOT_PROVIDER = new FallbackProvider(null);
    ...
    private CalendarText(String str, Locale locale, TextProvider textProvider) {
        ...
        TextWidth[] values3;
        TextWidth[] values4;
        OutputContext[] values5;
        OutputContext[] values6;
        OutputContext[] values7;
    ...
    /* renamed from: net.time4j.format.CalendarText$1 */
    /* loaded from: classes2.dex */
