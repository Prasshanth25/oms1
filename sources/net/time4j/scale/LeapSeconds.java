...
public final class LeapSeconds implements Iterable<LeapSecondEvent>, Comparator<LeapSecondEvent> {
    ...
    private LeapSeconds() {
        ...
        for (Map.Entry<GregorianDate, Integer> entry : leapSecondProvider.getLeapSecondTable().entrySet()) {
            treeSet.add(new SimpleLeapSecondEvent(entry.getKey(), Long.MIN_VALUE, (toPosix(key) - 62985600) - 1, entry.getValue().intValue()));
        }
        extend(treeSet);
    ...
    public int getShift(GregorianDate gregorianDate) {
        ExtendedLSE[] eventsInDescendingOrder;
    ...
    /* JADX WARN: Removed duplicated region for block: B:108:0x005a A[Catch: all -> 0x006a, TryCatch #0 {, blocks: (B:87:0x0009, B:89:0x0012, B:105:0x0043, B:106:0x0058, B:108:0x005a, B:109:0x0061, B:92:0x0024, B:94:0x002a, B:97:0x0031, B:99:0x0037, B:110:0x0062, B:111:0x0069), top: B:119:0x0009 }] */
    /*
    ...
    */
    ...
    private static long toPosix(GregorianDate gregorianDate) {
        return MathUtils.safeMultiply(MathUtils.safeSubtract(GregorianMath.toMJD(gregorianDate), (long) MJD_OFFSET), 86400L);
    }
