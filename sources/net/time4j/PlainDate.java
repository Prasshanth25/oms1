...
public final class PlainDate extends Calendrical<IsoDateUnit, PlainDate> implements GregorianDate, Normalizer<CalendarUnit>, LocalizedPatternSupport {
    ...
    public TimeSpan<CalendarUnit> normalize2(TimeSpan<? extends CalendarUnit> timeSpan) {
        return (Duration) until((PlainDate) plus(timeSpan), (TimeMetric<? extends U, Object>) Duration.inYearsMonthsDays());
    }
    ...
    public static PlainDate doAdd(CalendarUnit calendarUnit, PlainDate plainDate, long j, int i) {
    ...
    */
    ...
    private static class Merger implements ChronoMerger<PlainDate> {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:37:0x000f, code lost:
            if (r4 > (net.time4j.base.GregorianMath.isLeapYear(r3) ? 366 : 365)) goto L11;
         */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
    ...
    /* renamed from: net.time4j.PlainDate$1 */
    /* loaded from: classes2.dex */
    ...
    private static class EnumElementRule<V extends Enum<V>> implements ElementRule<PlainDate, V> {
        ...
        public /* bridge */ /* synthetic */ boolean isValid(PlainDate plainDate, Object obj) {
            return isValid(plainDate, (PlainDate) ((Enum) obj));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ PlainDate withValue(PlainDate plainDate, Object obj, boolean z) {
            return withValue(plainDate, (PlainDate) ((Enum) obj), z);
        }
