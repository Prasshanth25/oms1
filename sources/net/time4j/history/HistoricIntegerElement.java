...
public final class HistoricIntegerElement extends StdHistoricalElement implements DualFormatElement {
    ...
    public HistoricIntegerElement(char c, int i, int i2, ChronoHistory chronoHistory, int i3) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:222:0x016d  */
    ...
    */
    ...
    private static int parseNum(NumberSystem numberSystem, char c, CharSequence charSequence, int i, ParsePosition parsePosition, Leniency leniency) {
        ...
        if (numberSystem.isDecimal()) {
            ...
            r1 = leniency.isStrict() ? 0 : numberSystem.getDigits().charAt(0);
            ...
            while (i2 < min) {
                ...
                if (charAt2 >= 0 && charAt2 <= 9) {
                    j = (j * 10) + charAt2;
                    i3++;
                } else if (r1 == 0 || c == r1 || (charAt = charSequence.charAt(i2) - r1) < 0 || charAt > 9) {
                    break;
                } else {
                    j = (j * 10) + charAt;
                    i3++;
            ...
            if (r1 > 0) {
                int i5 = r1 + i;
                j = numberSystem.toInteger(charSequence.subSequence(i, i5).toString(), leniency);
                i = i5;
            }
        }
    ...
    private static class Rule<C extends ChronoEntity<C>> implements ElementRule<C, Integer> {
        ...
        public /* bridge */ /* synthetic */ boolean isValid(Object obj, Integer num) {
            return isValid((Rule<C>) ((ChronoEntity) obj), num);
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // net.time4j.engine.ElementRule
        public /* bridge */ /* synthetic */ Object withValue(Object obj, Integer num, boolean z) {
            return withValue((Rule<C>) ((ChronoEntity) obj), num, z);
        }
