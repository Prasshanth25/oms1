...
public enum SI implements ChronoUnit {
    ...
    public long between(Moment moment, Moment moment2) {
        ...
        int i2 = (elapsedTime > 0L ? 1 : (elapsedTime == 0L ? 0 : -1));
        return i2 < 0 ? moment2.getNanosecond() > moment.getNanosecond() ? elapsedTime + 1 : elapsedTime : (i2 <= 0 || moment2.getNanosecond() >= moment.getNanosecond()) ? elapsedTime : elapsedTime - 1;
    }

    /* renamed from: net.time4j.SI$1 */
    /* loaded from: classes2.dex */
