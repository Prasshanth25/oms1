            ...
            if (i != Integer.MIN_VALUE) {
                ...
                if (i2 != Integer.MIN_VALUE) {
                    if (i < 1 || i > AnnualDate.getMaxDay(i2)) {
                        ...
                        chronoEntity.with((ChronoElement<ValidationElement>) validationElement, (ValidationElement) ("Day-of-month out of bounds: " + i));
                    } else if (i2 >= 1 && i2 <= 12) {
                        return new AnnualDate(i2, i);
                    } else {
                        ValidationElement validationElement2 = ValidationElement.ERROR_MESSAGE;
                        chronoEntity.with((ChronoElement<ValidationElement>) validationElement2, (ValidationElement) ("Month out of bounds: " + i2));
                    }
                }
            }
            return null;
