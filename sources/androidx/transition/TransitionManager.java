...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        mo24clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo24clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo24clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo24clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo24clone = transition.mo24clone();
        sceneChangeSetup(viewGroup, mo24clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo24clone);
    }
