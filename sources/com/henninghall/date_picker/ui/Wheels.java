...
public class Wheels {
    ...
    private HashMap<WheelType, Wheel> getWheelPerType() {
        return new HashMap<WheelType, Wheel>() { // from class: com.henninghall.date_picker.ui.Wheels.2
            {
                Wheels.this = this;
                put(WheelType.DAY, this.dayWheel);
                put(WheelType.YEAR, this.yearWheel);
                put(WheelType.MONTH, this.monthWheel);
                put(WheelType.DATE, this.dateWheel);
                put(WheelType.HOUR, this.hourWheel);
                put(WheelType.MINUTE, this.minutesWheel);
                put(WheelType.AM_PM, this.ampmWheel);
            }
        };
    }
