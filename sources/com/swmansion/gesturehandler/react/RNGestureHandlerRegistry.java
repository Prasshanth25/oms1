        ...
        if (gestureHandler.getView() != null) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.swmansion.gesturehandler.react.RNGestureHandlerRegistry$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RNGestureHandlerRegistry.m398detachHandler$lambda4(GestureHandler.this);
                }
            });
        }
    }

    /* renamed from: detachHandler$lambda-4 */
    public static final void m398detachHandler$lambda4(GestureHandler handler) {
        Intrinsics.checkNotNullParameter(handler, "$handler");
        handler.cancel();
    }
