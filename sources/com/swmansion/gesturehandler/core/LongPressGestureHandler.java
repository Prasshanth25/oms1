...
public final class LongPressGestureHandler extends GestureHandler<LongPressGestureHandler> {
            ...
            if (j > 0) {
                ...
                handler.postDelayed(new Runnable() { // from class: com.swmansion.gesturehandler.core.LongPressGestureHandler$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        LongPressGestureHandler.m388onHandle$lambda0(LongPressGestureHandler.this);
                    }
                }, this.minDurationMs);
            } else if (j == 0) {
                activate();
    ...
    /* renamed from: onHandle$lambda-0 */
    public static final void m388onHandle$lambda0(LongPressGestureHandler this$0) {
