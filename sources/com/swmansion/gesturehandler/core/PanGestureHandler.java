...
public final class PanGestureHandler extends GestureHandler<PanGestureHandler> {
    ...
    private final Runnable activateDelayed = new Runnable() { // from class: com.swmansion.gesturehandler.core.PanGestureHandler$$ExternalSyntheticLambda0
        ...
        public final void run() {
            PanGestureHandler.m389activateDelayed$lambda0(PanGestureHandler.this);
        }
    };
    ...
    /* renamed from: activateDelayed$lambda-0 */
    public static final void m389activateDelayed$lambda0(PanGestureHandler this$0) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:234:0x008c, code lost:
