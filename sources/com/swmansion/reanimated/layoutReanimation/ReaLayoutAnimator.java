...
public class ReaLayoutAnimator extends LayoutAnimationController {
    ...
    public void deleteView(View view, final LayoutAnimationListener layoutAnimationListener) {
        ...
        try {
            ...
            this.mAnimationsManager.onViewRemoval(view, (ViewGroup) view.getParent(), new Runnable() { // from class: com.swmansion.reanimated.layoutReanimation.ReaLayoutAnimator$$ExternalSyntheticLambda0
