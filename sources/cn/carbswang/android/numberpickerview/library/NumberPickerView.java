...
public class NumberPickerView extends View {
    ...
    public void setDisplayedValues(String[] strArr) {
        ...
        correctPositionByDefaultValue(0, (this.mWrapSelectorWheel && this.mWrapSelectorWheelCheck) ? false : false);
        postInvalidate();
    ...
    public void smoothScrollToValue(int i, int i2, boolean z) {
        ...
        int refineValueByLimit2 = refineValueByLimit(i2, this.mMinValue, this.mMaxValue, (this.mWrapSelectorWheel && this.mWrapSelectorWheelCheck) ? false : false);
        if (this.mWrapSelectorWheel && this.mWrapSelectorWheelCheck) {
