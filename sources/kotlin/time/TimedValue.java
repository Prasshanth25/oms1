...
public final class TimedValue<T> {
    ...
    public final long m1917component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4 */
    public final TimedValue<T> m1918copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimedValue) {
            ...
            return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1769equalsimpl0(this.duration, timedValue.duration);
        }
        return false;
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1792hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1813toStringimpl(this.duration)) + ')';
    }
