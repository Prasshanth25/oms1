...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1759getAdjustmentUwyO8pc() {
    ...
    public long mo1756elapsedNowUwyO8pc() {
        return Duration.m1799minusLRDsOJo(this.mark.mo1756elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1758plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1800plusLRDsOJo(this.adjustment, j), null);
    }
}
