...
public interface TimeMark {
    ...
    TimeMark mo1757minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1758plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo */
        public static TimeMark m1900plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo */
        public static TimeMark m1899minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1758plusLRDsOJo(Duration.m1816unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1797isNegativeimpl(timeMark.mo1756elapsedNowUwyO8pc());
        }
