...
public final class UByteArrayKt {
    ...
    private static final byte[] m529ubyteArrayOfGBYM_sE(byte... elements) {
    ...
    private static final byte[] UByteArray(int i, Function1<? super Integer, UByte> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            bArr[i2] = init.invoke(Integer.valueOf(i2)).m510unboximpl();
        }
        return UByteArray.m513constructorimpl(bArr);
    }
}
