...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public void resumeWith(Object obj) {
        while (true) {
            ...
            if (obj2 == CoroutineSingletons.UNDECIDED) {
                if (Cookie$$ExternalSyntheticBackport0.m(RESULT, this, CoroutineSingletons.UNDECIDED, obj)) {
                    return;
                }
            } else if (obj2 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                throw new IllegalStateException("Already resumed");
            } else {
                if (Cookie$$ExternalSyntheticBackport0.m(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
    ...
    public final Object getOrThrow() {
        ...
        if (obj == CoroutineSingletons.UNDECIDED) {
            if (Cookie$$ExternalSyntheticBackport0.m(RESULT, this, CoroutineSingletons.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
