...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m946containsWZ4Q5Ns(((UInt) obj).m588unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UInt.m531boximpl(m947getpVg5ArA(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m948indexOfWZ4Q5Ns(((UInt) obj).m588unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m949lastIndexOfWZ4Q5Ns(((UInt) obj).m588unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UIntArray.m597getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UIntArray.m599isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-WZ4Q5Ns */
    public boolean m946containsWZ4Q5Ns(int i) {
        return UIntArray.m592containsWZ4Q5Ns(this.$this_asList, i);
    }

    /* renamed from: get-pVg5ArA */
    public int m947getpVg5ArA(int i) {
        return UIntArray.m596getpVg5ArA(this.$this_asList, i);
    }
