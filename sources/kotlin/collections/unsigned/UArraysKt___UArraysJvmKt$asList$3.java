...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m954contains7apg3OU(((UByte) obj).m510unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UByte.m455boximpl(m955getw2LRezQ(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UByte) {
            return m956indexOf7apg3OU(((UByte) obj).m510unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UByte) {
            return m957lastIndexOf7apg3OU(((UByte) obj).m510unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UByteArray.m519getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UByteArray.m521isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-7apg3OU */
    public boolean m954contains7apg3OU(byte b) {
        return UByteArray.m514contains7apg3OU(this.$this_asList, b);
    }

    /* renamed from: get-w2LRezQ */
    public byte m955getw2LRezQ(int i) {
        return UByteArray.m518getw2LRezQ(this.$this_asList, i);
    }
