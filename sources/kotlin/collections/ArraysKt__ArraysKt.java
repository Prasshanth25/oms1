        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m1009contentEqualskV0jMPg(((UByteArray) t).m527unboximpl(), ((UByteArray) t2).m527unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m1006contentEqualsFGO6Aew(((UShortArray) t).m787unboximpl(), ((UShortArray) t2).m787unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m1007contentEqualsKJPZfPQ(((UIntArray) t).m605unboximpl(), ((UIntArray) t2).m605unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m1011contentEqualslec5QzE(((ULongArray) t).m683unboximpl(), ((ULongArray) t2).m683unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m1023contentToString2csIQuQ(uByteArray != null ? uByteArray.m527unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m1027contentToStringd6D3K8(uShortArray != null ? uShortArray.m787unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m1026contentToStringXUkPCBk(uIntArray != null ? uIntArray.m605unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m1029contentToStringuLth9ew(uLongArray != null ? uLongArray.m683unboximpl() : null));
            } else {
