    ...
    public final R runCallLoop() {
        ...
        while (true) {
            ...
            if (continuation != null) {
                obj = DeepRecursiveKt.UNDEFINED_RESULT;
                if (!Result.m445equalsimpl0(obj, r)) {
                    ...
                    try {
                        ...
                        if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m443constructorimpl(invoke));
                        }
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.Companion;
                        continuation.resumeWith(Result.m443constructorimpl(ResultKt.createFailure(th)));
                    }
                }
            } else {
